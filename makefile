...
SRC = ft_isprint.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c ft_strlcpy.c\
		ft_strlen.c ft_memset.c ft_bzero.c ft_memcpy.c ft_memmove.c ft_memmove.c\
